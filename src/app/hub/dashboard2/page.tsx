...
// Design Tokens (from sagi-dashboard-spec.md)
const T = {
  bg:        '#050506',
  bgDeep:    '#020203',
  bgElevated:'#0a0a0c',
    ...
    <div style={{minHeight:'100vh',fontFamily:T.font,color:T.fg,background:T.bg,position:'relative',overflow:'hidden'}}>
      ...
      <style>{`
        *{box-sizing:border-box}
        ...
        /* >= 1024px: 4-col stats, dual-column layout (default) */
        .d2-stats { display:grid; grid-template-columns:repeat(4,1fr); gap:10px; }
        .d2-mid   { display:grid; grid-template-columns:270px 1fr; gap:10px; }
        .d2-bottom{ display:grid; grid-template-columns:1fr 1fr; gap:10px; }
        .d2-header{ display:flex; align-items:flex-end; justify-content:space-between; }
        .d2-meta  { display:flex; align-items:center; gap:10px; }

        /* 640–1023px: 2-col stats, adaptive layout */
        @media (max-width:1023px) {
          .d2-stats  { grid-template-columns:repeat(2,1fr); }
          .d2-mid    { grid-template-columns:1fr 1fr; }
        }

        /* < 640px: 2-col stats, single column, full-width cards */
        @media (max-width:639px) {
          .d2-stats  { grid-template-columns:repeat(2,1fr); }
          .d2-mid    { grid-template-columns:1fr; }
          .d2-bottom { grid-template-columns:1fr; }
          .d2-header { flex-wrap:wrap; gap:12px; }
          .d2-meta   { flex-wrap:wrap; gap:6px; }
        }
      ...
      <div style={{position:'relative',zIndex:1,maxWidth:1320,margin:'0 auto',padding:'28px 24px'}}>
        ...
        {/* Header */}
        <div className="d2-header" style={{marginBottom:28}}>
          <div>
        ...
        {!data?(
          ...
          <div style={{display:'flex',flexDirection:'column',gap:12}}>
            ...
            {/* Middle two-column: system overview + token chart */}
            <div className="d2-mid">
              <Card>
            ...
            {/* Bottom two-column: running + recent completed */}
