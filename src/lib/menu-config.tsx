...
export const PORTAL_MENU_ITEMS: MenuItem[] = [
  // 營業核心
  { id: 'performance', title: '業績管理', desc: 'Pipeline 追蹤 · 目標達成率 · 團隊績效', href: '/portal/performance', icon: 'pipeline', gradient: 'from-blue-500 to-blue-600', textColor: 'text-blue-100', status: 'live', group: 'sales' },
  { id: 'products', title: '產品目錄', desc: '搜尋產品 · 牌價經銷價 · 即時庫存', href: '/portal/products', icon: 'product', gradient: 'from-emerald-500 to-emerald-600', textColor: 'text-emerald-100', status: 'live', group: 'sales' },
  { id: 'quotations', title: '報價單', desc: '快速開立報價 · PDF 匯出 · 歷史查詢', href: '/portal/quotations', icon: 'quotation', gradient: 'from-orange-500 to-orange-600', textColor: 'text-orange-100', status: 'beta', group: 'sales' },
  // 效率工具
  ...
  { id: 'admin', title: '後台管理', desc: '目標設定 · 團隊管理 · 經銷商維護', href: '/portal/admin', icon: 'admin', gradient: 'from-gray-600 to-gray-700', textColor: 'text-gray-300', status: 'live', group: 'system' },
]
...
export const ADMIN_MENU_ITEMS: AdminItem[] = [
  { title: '目標管理', desc: '年度 · 月度 · 個人目標設定', href: '/portal/admin/targets', icon: 'target', color: '#3B82F6', group: 'core' },
  { title: '業務團隊', desc: '業務員資料 · 職責分配', href: '/portal/admin/team', icon: 'team', color: '#10B981', group: 'core' },
  { title: '經銷商管理', desc: '經銷商資料 · 聯絡人 · 區域', href: '/portal/admin/dealers', icon: 'dealer', color: '#8B5CF6', group: 'core' },
  { title: '影片管理', desc: '案例影片 · 分類 · 連結', href: '/portal/admin/videos', icon: 'video', color: '#EF4444', group: 'content' },
  { title: '簡報管理', desc: '簡報範本 · 分類 · 權限', href: '/portal/admin/slides', icon: 'slides', color: '#F59E0B', group: 'content' },
  { title: '資料同步', desc: 'Funnel 報表上傳 · 資料匯入', href: '/portal/admin/sync', icon: 'sync', color: '#F97316', group: 'system' },
  { title: '系統日誌', desc: '登入紀錄 · 操作紀錄 · 錯誤', href: '/portal/admin/logs', icon: 'logs', color: '#06B6D4', group: 'system' },
  { title: '管理員管理', desc: '新增 · 移除管理員帳號', href: '/portal/admin/admins', icon: 'adminManage', color: '#EC4899', group: 'system', superOnly: true },
]
...
export const MARKETING_MENU_ITEMS: MarketingItem[] = [
  ...
  },
  {
    ...
    href: '/portal/marketing/walker-docs',
    icon: 'robot',
    color: '#8B5CF6',
  },
]
